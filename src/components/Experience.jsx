...
const timeline = [
  ...
  { time: '00:20', label: 'Opening Set', desc: 'Ambient bass eases the room in. Mats laid. Bodies loosening.' },
  { time: '01:00', label: 'Flow Begins', desc: 'The instructor leads a full bass-matched yoga sequence as the DJ builds the drop.' },
  { time: '01:45', label: 'Peak Energy', desc: 'The set peaks. Movement matches the music. Pure synchrony.' },
  { time: '02:10', label: 'Cool Down', desc: 'The music softens. Poses slow. Liquid DnB carries the final stretch.' },
  { time: '02:30', label: 'Savasana', desc: 'Sub-bass holds the room in silence-as-sound. Pure stillness.' },
  { time: '02:45', label: 'Afterglow', desc: 'Drinks, connection, vinyl. The night continues.' },
]
